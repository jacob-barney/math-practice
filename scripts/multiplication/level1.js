...
//create equations
let additionProblems = createRandomEquations('multiplication', levelOne, 20);
...
function compare (array1, array2) {
    ...
    for (let i = 0; i < array1.length; i++) {
        ...
        if (array1[i] === array2[i]) {
            rightAnswers++;
            answers[i].style.backgroundColor = 'rgba(100, 255, 100, 0.7';
            console.log(i + ' is correct');

        } else {
            answers[i].style.backgroundColor = 'rgba(255, 50, 50, 0.8)';
