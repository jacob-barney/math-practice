...
let levelFour = [4,5,6,7,8,9];
let levelFive = [5,6,7,8,9,10,11];
...
//LOGIC IS WORKING, WHY ISNT THE DONE BUTTON?
...
// doneButton.addEventListener('click', getInnerText(problems));
// doneButton.addEventListener('click', getInnerText(problems));
// doneButton.addEventListener('click', getInnerText(problems));
// doneButton.addEventListener('click', getInnerText(problems));
// doneButton.addEventListener('click', getInnerText(problems));
